# -*- coding: utf-8 -*-
"""
Created on Tue Jul 13 18:12:27 2021
...
dataset = pd.read_csv(r"C:\Users\Sneha\Downloads\Restaurant_Reviews.tsv",delimiter = "\t")
...
model.fit(x_train.astype(np.float),y_train.astype(np.float),epochs=5)
